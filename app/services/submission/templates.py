...
_GROUNDING_INSTRUCTION = (
    ...
    "fabricating values.\n\n"
    "FORMATTING: Write in a professional, authoritative tone. Use proper Markdown "
    "headings, numbered sections, and tables where appropriate. Omit any fields "
    "marked as '[NOT AVAILABLE]' rather than repeating the placeholder text. "
    "Focus on the data that IS available and build a compelling narrative around it."
)
...
DOCUMENT_TEMPLATES = {
    "cover_letter": {
        "system_prompt": (
            f"{SAFETY_PREAMBLE}\n\n"
            "You are a senior urban planning consultant at a reputable Toronto firm. "
            "Write a formal cover letter to the City of Toronto Planning Department "
            "introducing a development application. The letter must be polished, "
            "authoritative, and suitable for direct submission to municipal staff.\n\n"
            "Format as a proper business letter with:\n"
            "- Date and addressee (Director of Community Planning, relevant district)\n"
            "- RE: line with address and application type\n"
            "- 3-4 substantive paragraphs\n"
            "- Professional closing\n\n"
            "Do NOT include placeholder text for any missing information. "
            "Only reference data that is actually provided.\n\n"
        ...
        "user_prompt_template": (
            ...
            "{variance_summary}\n\n"
            "The letter should:\n"
            "1. Introduce the applicant and property with its municipal address\n"
            "2. Describe the proposed development with key metrics (height, units, GFA)\n"
            "3. Note the zoning and any required approvals (as-of-right, minor variance, or ZBA)\n"
            "4. Reference the enclosed submission package documents\n"
            "5. Provide contact information for follow-up\n\n"
            "Skip any metric that shows as '[NOT AVAILABLE]' — just omit it entirely."
        ),
        "max_tokens": 2048,
    },
    ...
    "planning_rationale": {
        "system_prompt": (
            ...
            "to the City of Toronto. This is a formal document that will be reviewed by "
            "city planning staff and possibly presented at Committee of Adjustment or Council.\n\n"
            "Structure the document with these sections:\n"
            "1. **Introduction** — Purpose, applicant, property description\n"
            "2. **Site & Surrounding Context** — Location, neighbourhood character, transit access\n"
            "3. **Proposed Development** — Description with all available metrics\n"
            "4. **Policy Framework Analysis** — For each applicable policy layer, analyze conformity\n"
            "5. **Zoning Compliance** — By-law 569-2013 analysis with specific section references\n"
            "6. **Variance Justification** — If variances needed, justify against the four statutory tests\n"
            "7. **Precedent Analysis** — Reference comparable approved applications\n"
            "8. **Planning Opinion** — Professional conclusion and recommendation\n\n"
            "Write substantively — each section should be 2-4 paragraphs minimum. "
            "Use specific by-law section numbers when referencing zoning standards. "
            "Omit any data marked '[NOT AVAILABLE]' rather than including the placeholder.\n\n"
            f"{_GROUNDING_INSTRUCTION}\n\n"
            f"{get_policy_grounding('planning_rationale')}"
        ),
        "user_prompt_template": (
            "Write a comprehensive Planning Rationale for this development proposal:\n\n"
            "## Site Information\n"
            "Address: {address}\n"
            ...
            "## Zoning Standards (By-law 569-2013)\n"
            "{setback_data}\n\n"
            "## Policy Context\n"
            ...
            "## Municipal Servicing\n"
            "{servicing_summary}\n\n"
            "Write a thorough, professional planning rationale. For each policy layer, "
            "explain HOW the proposal conforms (not just that it does). If variances are "
            "required, address each against the four statutory tests under s.45(1). "
            "Include a section on municipal servicing adequacy if data is available."
        ),
        "max_tokens": 8192,
    },
    ...
    "due_diligence_report": {
        ...
        "user_prompt_template": (
            ...
            "Include infrastructure servicing adequacy in the risk assessment if data is available."
        ),
        "max_tokens": 5000,
    },
