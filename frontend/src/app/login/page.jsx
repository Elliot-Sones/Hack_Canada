...
export default function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Give Better Auth a moment to set the session cookie
            await new Promise(r => setTimeout(r, 300));
            try {
                await sessionExchange();
            } catch {
                // Retry once if cookie wasn't ready
            ...
            <div className="form-section">
                ...
                <div className="auth-card">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0 12px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#78716c', textTransform: 'uppercase', letterSpacing: '0.05em' }}>or</span>
                        <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255,255,255,0.1)' }} />
                    </div>
